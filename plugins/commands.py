...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[           
            InlineKeyboardButton('📢 Uᴩᴅᴀᴛᴇꜱ 📢', url='https://t.me/')
            ],[
            InlineKeyboardButton('ℹ️ Hᴇʟᴩ ℹ️', url="https://t.me/")
        ]]
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton("Cʜᴀɴɴᴇʟ 🔈", url="https://t.me/")
            ],[      
            InlineKeyboardButton("Hᴇʟᴩ 🕸️", url="https://t.me/"),
